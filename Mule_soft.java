...
public class Mule_soft {
    ...
    public Mule_soft() {
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3304/movies", "", "");
        } catch (Exception e) {
    ...
    public void make_table() {
        try {
            ...
            String query = "CREATE TABLE movie(id INT AUTO_INCREMENT,name VARCHAR(50),actor varchar(20),actress varchar(20),
            director varchar(20), year INT, PRIMARY KEY(id))";
